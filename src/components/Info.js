...
export default function Info() {
    return (
        <section className="info">
            ...
            <a className="info--website" href="https://localhost:8080" target="_blank">lucywebsite.me</a>
            <div className="info--buttonscontainer">
                <a href="#" target="_blank"><button className="info--button"><i className="fas fa-envelope"></i> Email</button></a>
